...
namespace FSecure.Utils.ExtensionMethods
{
    public static class StringExtensions
    {
        ...
        public static string Capitalized(this string text)
        {
            ...
            if (text.Length == 1) return text.ToUpper(CultureInfo.CurrentUICulture);

            return char.ToUpper(text[0], CultureInfo.CurrentUICulture) 
                + text.Substring(1).ToLower(CultureInfo.CurrentUICulture);
        }
    }
}
